...
func init() {
	...
	flag.BoolVar(&Settings.outputHTTPConfig.keepRedirectHeaders, "output-http-keep-redirects-headers", false, "Keep headers request when http redirect is enabled.")
