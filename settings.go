...
func init() {
	...
	flag.IntVar(&Settings.bufferSize, "emitter-buffer-size", DEFAULT_EMITTER_BUFFER, string("Maximum request size in KB that gor can process. Default and minimum: " + string(DEFAULT_EMITTER_BUFFER)))
